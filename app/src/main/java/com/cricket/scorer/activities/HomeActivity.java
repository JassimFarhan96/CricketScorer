...
public class HomeActivity extends BaseNavActivity {
    private LinearLayout layoutMatches, layoutTournaments, layoutBackupRestore, layoutHelp, layoutReportBug;
    ...
    @Override protected void onCreate(Bundle s) {
        ...
        layoutBackupRestore = findViewById(R.id.layout_backup_restore);
    ...
    private void setClickListeners() {
        ...
        layoutBackupRestore.setOnClickListener(v ->
                startActivity(new Intent(this, BackupRestoreMenuActivity.class)));
